...
type TProps = {
  ...
  selectedScheduleIds: string[] | undefined;
    ...
    <>
      <FormControl sx={{ width: "100%" }}>
        ...
        <Select
          ...
          input={
            <OutlinedInput id="select-multiple-chip" label="Select Slot" />
          }
              ...
              <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                {selected.map((value: any) => {
                  ...
                  const formattedTimeSlot = `${getTimeIn12HourFormat(
                    selectedSchedule?.startDate as string
                  )} - ${getTimeIn12HourFormat(
                    selectedSchedule?.endDate as string
                  )}`;
